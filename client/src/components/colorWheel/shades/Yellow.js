...
const Yellow = () => {
  ...
  const emotionSentence = `This person feels like ${emotionPercentage}% of ${YellowPositiveEmotions} and ${
    100 - emotionPercentage
  }% of ${YellowNegativeEmotions}.`;

  const getColorShade = (percentage) => {
    const red = 255 - percentage * 0.5;
    const green = 255 - percentage * 0.5;
