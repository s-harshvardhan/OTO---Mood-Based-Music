...
const Orange = () => {
  ...
  const getColorShade = (percentage) => {
    ...
    const green = percentage * 2.55; // Convert percentage to a scale of 0-255 for green
    return `rgb(${red}, ${green}, 0)`; // Use the red and green values for the red and green channels, and 0 for blue
  };
